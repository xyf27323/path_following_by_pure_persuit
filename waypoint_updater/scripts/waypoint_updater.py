...
class WaypointUpdater(object):
    def __init__(self):
        ...
        self.final_waypoints_pub = rospy.Publisher('final_waypoints', Lane, queue_size=1)  #Lane has both pose and twist
        self.final_path_pub = rospy.Publisher('final_path', Path, queue_size=1)    #Path has no twist
